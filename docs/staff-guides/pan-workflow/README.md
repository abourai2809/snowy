...
- [Store Staff](store-staff.md)
- [Store Manager](store-manager.md)
- [Admin](admin.md)

The feature flowchart is for owners and managers:

- [Pan workflow flowchart](flowchart.md)

## Simple Words

- **Pan ID**: the label on one physical gelato pan.
